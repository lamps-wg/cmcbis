...
informative:
  ...
  CMC-COMPL: I-D.ietf-lamps-rfc5274bis
  CMC-Updates: RFC6402
...
{{erratum8027}}, {{erratum7629}}, {{erratum7628}}, {{erratum7627}},
{{erratum7379}}, {{erratum6571}}, {{erratum5931}}, {{erratum4775}},
{{erratum2731}}, and {{erratum2063}}.
...
#####  CRMF Certification Syntax {#CRMFCertificationSyntax}
...
##  Full PKI Response {#FullPKIResponse}
...
####  POP Link Witness Control {#POPLinkWitnessControl}
...
2. The client MUST include an Identity Proof control ({{IdentityProofControl}})
...
request, controls in CRMF {{Section 6 of CRMF}}, and the various
CMS attribute sequences.

## Change Subject Name Attribute {#ChangeSubjectNameAttribute}
...
#  Registration Authorities {#RegistrationAuthorities}
...
* Adding private or standardized certificate extensions to all
...
##  Signature Layer Removal {#SignatureRemoval}
...
additional items that MAY appear in CMC server certificates.  {{ExtendedKeyUsage}}
defines some additional values for the Extended Key Usage
extension.  {{SubjectInformationAccess}} defines a new Subject Information Access
...
## Subject Information Access {#SubjectInformationAccess}
...
defined in {{ExtendedKeyUsage}} MUST be included in the certificate as well.
...
{{FullPKIRequest}})  The semantics of other name forms of accessLocation
...
controls described in {{TransactionIdentifierControlandSenderandRecipientNonceControls}}.  Developers of state-constrained
...
##  Request of a Signing Certificate {#RequestofaSigningCertificate}
...
##  Single Certification Request, But Modified by RA {#SingleCertificationRequestModifiedbyRA}
...
##  No-Signature Signature Mechanism {#NoSig-Sig}
...
Thank you to Charlie Kaufman, Orie Steele, Paul Wouters, Éric Vyncke, Mike Bishop,
Reese Enghardt, and Mohamed Boucadair for reviewing the document and providing comments.
